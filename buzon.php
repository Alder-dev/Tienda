...
<head>
	...
	<title> Buzon - PC & Components</title>
...
<button class="bton bton-primary" href="buzon.php" type="submit" role="button" value="Limpiar">Limpiar</button>
</form>
