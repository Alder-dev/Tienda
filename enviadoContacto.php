...
<?php 
	...
	$namep = $_POST["nameh"];
	$apellidop = $_POST["apellidoh"];
	$emailp = $_POST["emailh"];
	$mensajep = $_POST["mensajeh"];

		$conexion = mysqli_connect("localhost", "root", "");
		mysqli_select_db($conexion, "tienda");

		$insertar = "INSERT INTO buzon_contacto(nombre, apellido, email, mensaje) VALUES('$namep', '$apellidop', '$emailp', '$mensajep')";
...
?>
<hr>
<a class="bton bton-primary" href="contacto.php" role="button"> Ir a inicio</a>